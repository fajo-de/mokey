...
func SetDefaults() {
	...
	viper.SetDefault("accounts.require_admin_verify", true)
	viper.SetDefault("accounts.enable_user_signup", true)
	viper.SetDefault("accounts.enable_user_sshkey", true)
	...
	viper.SetDefault("accounts.hide_indirect_groups", true)
	viper.SetDefault("accounts.require_group_no_indirect", false)
	...
	viper.SetDefault("email.from_name", "Identity Management")
	viper.SetDefault("email.subject_prefix", "[IDM] ")
	viper.SetDefault("email.subject_suffix", "")
